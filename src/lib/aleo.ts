...
export const PASSMEET_V1_PROGRAM_ID = process.env.NEXT_PUBLIC_PASSMEET_V1_PROGRAM_ID || "passmeet_v3_7788.aleo";
export const PASSMEET_SUBS_PROGRAM_ID =
  process.env.NEXT_PUBLIC_PASSMEET_SUBS_PROGRAM_ID || "passmeet_subs_v3_7788.aleo";
