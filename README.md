...
- Aleo programs
  - `passmeet_v4_7788.aleo`: events, tickets, payment-atomic purchase, verify-entry nullifiers
  - `passmeet_subs_v4_7788.aleo`: subscriptions, payment-atomic subscribe, validity by block height
- Payments
...
- Create event
  - UI -> wallet executes `create_event(capacity, price_credits, price_usdcx, price_usad)` on `passmeet_v4_7788.aleo`
...
- Subscribe
  - `subscribe_with_credits(tier, credits_record)` or `subscribe(tier, token_record)` on `passmeet_subs_v4_7788.aleo`
