const { Account, ProgramManager, NetworkManager } = require('@aleohq/sdk');
...
async function register() {
    try {
        ...
        const networkClient = new NetworkManager("https://api.explorer.provable.com/v1");
        networkClient.setNetwork("testnet");
        
        // Setup Program Manager
        const programManager = new ProgramManager("https://api.explorer.provable.com/v1", networkClient.getNetwork(), networkClient);
